    ...
    <section className="py-16 sm:py-24 lg:py-32 bg-card">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          <div>
            <p className="text-navy-light uppercase tracking-[0.2em] text-xs sm:text-sm font-semibold mb-4">
            ...
            <div className="flex items-center gap-3 text-foreground">
              <MapPin size={20} className="text-navy-light shrink-0" />
              <span className="font-medium text-sm sm:text-base">Campinas, São Paulo — Brasil</span>
            </div>
          </div>
          <div className="rounded-sm overflow-hidden shadow-xl h-64 sm:h-80">
            <iframe

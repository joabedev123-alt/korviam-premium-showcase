      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16">
          <div className="reveal-left">
            <p className="text-navy-light uppercase tracking-[0.2em] text-sm font-semibold mb-4">Contato</p>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium text-foreground">(19) 0000-0000</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-sm bg-navy flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="font-medium text-foreground">contato@korviam.com.br</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-sm bg-navy flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="font-medium text-foreground">Campinas, São Paulo</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="reveal-right">
            <form onSubmit={handleSubmit} className="bg-card p-8 rounded-sm shadow-xl space-y-5">
              <div>

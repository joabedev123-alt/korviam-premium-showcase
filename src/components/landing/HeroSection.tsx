    ...
    <section id="inicio" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 text-center pt-24 pb-16">
        <div className="max-w-4xl mx-auto">
          ...
          <p
            className="text-silver text-sm sm:text-base md:text-lg lg:text-xl max-w-2xl mx-auto mb-8 md:mb-10 leading-relaxed animate-fade-in-up"
          ...
          >
            <a
              ...
              className="inline-flex items-center justify-center gap-3 px-7 py-4 sm:px-10 sm:py-5 bg-[#25D366] text-white font-black rounded-lg hover:bg-[#12883d] transition-all duration-300 shadow-[0_8px_20px_rgba(37,211,102,0.4)] hover:-translate-y-1 hover:shadow-[0_12px_28px_rgba(37,211,102,0.5)] active:scale-95 text-sm sm:text-base"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-3 px-7 py-4 sm:px-10 sm:py-5 border-2 border-[#25D366] text-[#25D366] font-black rounded-lg hover:bg-[#25D366]/10 transition-all duration-300 shadow-lg hover:-translate-y-1 active:scale-95 bg-white/5 backdrop-blur-sm text-sm sm:text-base"
            >
              <WhatsAppIcon size={36} color="#25D366" className="shrink-0" />
